...
namespace AnyView
{
    public sealed class SwipeListViewItem : ListViewItem
    {
        ...
        public static readonly DependencyProperty IsSwipedRightMemberPathProperty =
            DependencyProperty.Register(nameof(IsSwipedRightMemberPath), typeof(string), typeof(SwipeListViewItem), new PropertyMetadata(null));
        ...
        public static readonly DependencyProperty IsSwipedRightProperty =
            DependencyProperty.Register(nameof(IsSwipedRight), typeof(bool), typeof(SwipeListViewItem), new PropertyMetadata(false, (o, args) => SwipeByDependencyChange(o, args, SwipeDirection.Right)));
        ...
        public static readonly DependencyProperty IsSwipedLeftMemberPathProperty =
            DependencyProperty.Register(nameof(IsSwipedLeftMemberPath), typeof(string), typeof(SwipeListViewItem), new PropertyMetadata(null));
        ...
        public static readonly DependencyProperty IsSwipedLeftProperty =
            DependencyProperty.Register(nameof(IsSwipedLeft), typeof(bool), typeof(SwipeListViewItem), new PropertyMetadata(false, (o, args) => SwipeByDependencyChange(o, args, SwipeDirection.Left)));
        ...
        public static readonly DependencyProperty EnableSwipeRightMemberPathProperty =
            DependencyProperty.Register("EnableSwipeRightMemberPath", typeof(string), typeof(SwipeListViewItem), new PropertyMetadata(null));
        ...
        public static readonly DependencyProperty EnableSwipeRightProperty =
            DependencyProperty.Register("EnableSwipeRight", typeof(bool), typeof(SwipeListViewItem), new PropertyMetadata(true, (s, e) => ((SwipeListViewItem)s).UpdateConfig()));
        ...
        public static readonly DependencyProperty EnableSwipeLeftMemberPathProperty =
            DependencyProperty.Register("EnableSwipeLeftMemberPath", typeof(string), typeof(SwipeListViewItem), new PropertyMetadata(null));
        ...
        public static readonly DependencyProperty EnableSwipeLeftProperty =
            DependencyProperty.Register("EnableSwipeLeft", typeof(bool), typeof(SwipeListViewItem), new PropertyMetadata(true, (s, e) => ((SwipeListViewItem)s).UpdateConfig()));
        ...
        public static readonly DependencyProperty IsSwipeEnabledProperty =
            DependencyProperty.Register(nameof(IsSwipeEnabled), typeof(bool), typeof(SwipeListViewItem),
                new PropertyMetadata(true, (s, e) =>
                {
                    var listViewItem = s as SwipeListViewItem;
        ...
        public static readonly DependencyProperty ItemManipulationModeProperty =
            DependencyProperty.Register(nameof(ItemManipulationMode), typeof(ManipulationModes), typeof(SwipeListViewItem), new PropertyMetadata(ManipulationModes.TranslateX | ManipulationModes.System));
        ...
        public static readonly DependencyProperty LeftSwipeContentTemplateProperty =
            DependencyProperty.Register(nameof(LeftSwipeContentTemplate), typeof(DataTemplate), typeof(SwipeListViewItem), new PropertyMetadata(null));
        ...
        public static readonly DependencyProperty RightSwipeContentTemplateProperty =
            DependencyProperty.Register(nameof(RightSwipeContentTemplate), typeof(DataTemplate), typeof(SwipeListViewItem), new PropertyMetadata(null));
        ...
        public static readonly DependencyProperty BackAnimDurationProperty =
            DependencyProperty.Register(nameof(BackAnimDuration), typeof(int), typeof(SwipeListViewItem), new PropertyMetadata(200, (s, e) => ((SwipeListViewItem)s).UpdateConfig()));
        ...
        public static readonly DependencyProperty LeftSwipeModeProperty =
            DependencyProperty.Register(nameof(LeftSwipeMode), typeof(SwipeMode), typeof(SwipeListViewItem), new PropertyMetadata(SwipeMode.None, (s, e) => ((SwipeListViewItem)s).UpdateConfig()));
        ...
        public static readonly DependencyProperty LeftBackAnimEasingFunctionProperty =
            DependencyProperty.Register(nameof(LeftBackAnimEasingFunction), typeof(EasingFunctionBase), typeof(SwipeListViewItem), new PropertyMetadata(new ExponentialEase() { EasingMode = EasingMode.EaseOut }, (s, e) => ((SwipeListViewItem)s).UpdateConfig()));
        ...
        public static readonly DependencyProperty LeftSwipeMaxLengthProperty =
            DependencyProperty.Register(nameof(LeftSwipeMaxLength), typeof(double), typeof(SwipeListViewItem), new PropertyMetadata(0.0));
        ...
        public static readonly DependencyProperty LeftSwipeLengthRateProperty =
            DependencyProperty.Register(nameof(LeftSwipeLengthRate), typeof(double), typeof(SwipeListViewItem), new PropertyMetadata(1.0, (s, e) => ((SwipeListViewItem)s).UpdateConfig()));
        ...
        public static readonly DependencyProperty LeftActionRateForSwipeLengthProperty =
            DependencyProperty.Register(nameof(LeftActionRateForSwipeLength), typeof(double), typeof(SwipeListViewItem), new PropertyMetadata(0.5, (s, e) => ((SwipeListViewItem)s).UpdateConfig()));
        ...
        public static readonly DependencyProperty RightSwipeModeProperty =
            DependencyProperty.Register(nameof(RightSwipeMode), typeof(SwipeMode), typeof(SwipeListViewItem), new PropertyMetadata(SwipeMode.None, (s, e) => ((SwipeListViewItem)s).UpdateConfig()));
        ...
        public static readonly DependencyProperty RightSwipeMaxLengthProperty =
            DependencyProperty.Register(nameof(RightSwipeMaxLength), typeof(double), typeof(SwipeListViewItem), new PropertyMetadata(0.0));
        ...
        public static readonly DependencyProperty RightSwipeLengthRateProperty =
            DependencyProperty.Register(nameof(RightSwipeLengthRate), typeof(double), typeof(SwipeListViewItem), new PropertyMetadata(1.0, (s, e) => ((SwipeListViewItem)s).UpdateConfig()));
        ...
        public static readonly DependencyProperty RightActionRateForSwipeLengthProperty =
            DependencyProperty.Register(nameof(RightActionRateForSwipeLength), typeof(double), typeof(SwipeListViewItem), new PropertyMetadata(0.5, (s, e) => ((SwipeListViewItem)s).UpdateConfig()));
        ...
        public static readonly DependencyProperty RightBackAnimEasingFunctionProperty =
            DependencyProperty.Register(nameof(RightBackAnimEasingFunction), typeof(EasingFunctionBase), typeof(SwipeListViewItem), new PropertyMetadata(new ExponentialEase() { EasingMode = EasingMode.EaseOut }, (s, e) => ((SwipeListViewItem)s).UpdateConfig()));
        ...
        public SwipeListViewItem()
        {
            ...
            Loaded += SwipeListViewItem_Loaded;
            _swipeAnimationConstructor = SwipeReleaseAnimationConstructor.Create(new SwipeConfig());
        }

        private void SwipeListViewItem_Loaded(object sender, RoutedEventArgs e)
        {
            _isLoaded = true;
            UpdateConfig();
            SyncSwipeStateToBindings();
            SizeChanged += SwipeListViewItem_SizeChanged;
        }
        ...
        {
            var ctrl = (SwipeListViewItem)obj;
        ...
        private void SwipeListViewItem_SizeChanged(object sender, SizeChangedEventArgs e)
        {
            UpdateConfig();
            ResetSwipe();
        }
        ...
        public T GetSwipeControl<T>(SwipeDirection direction, string name) where T : FrameworkElement
        {
            ...
            return AnyViewUtils.FindVisualChild<T>(contentCtrl, name);
        }
    }
}
