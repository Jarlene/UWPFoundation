...
namespace AnyView
{
    public sealed class SwipeListView : ListView
    {
        ...
        public static readonly DependencyProperty CanPullToRefreshProperty =
            DependencyProperty.Register("CanPullToRefresh", typeof(bool), typeof(SwipeListView), new PropertyMetadata(false));
        ...
        public static readonly DependencyProperty RefreshAreaHeightProperty =
            DependencyProperty.Register("RefreshAreaHeight", typeof(double), typeof(SwipeListView), new PropertyMetadata(50.0));
        ...
        public static readonly DependencyProperty RefreshProgressRingBrushProperty =
            DependencyProperty.Register("RefreshProgressRingBrush", typeof(Brush), typeof(SwipeListView), new PropertyMetadata(Application.Current.Resources["ProgressBarForegroundThemeBrush"]));
        ...
        public static readonly DependencyProperty RefreshProgressBarBrushProperty =
            DependencyProperty.Register("RefreshProgressBarBrush", typeof(Brush), typeof(SwipeListView), new PropertyMetadata(Application.Current.Resources["ProgressBarForegroundThemeBrush"]));
        ...
        public static readonly DependencyProperty LoadMoreProgressBarBrushProperty =
            DependencyProperty.Register("LoadMoreProgressBarBrush", typeof(Brush), typeof(SwipeListView), new PropertyMetadata(Application.Current.Resources["ProgressBarForegroundThemeBrush"]));
        ...
        public static readonly DependencyProperty FloatButtonForegroundProperty =
            DependencyProperty.Register("FloatButtonForeground", typeof(Brush), typeof(SwipeListView), new PropertyMetadata(new SolidColorBrush(Colors.White)));
        ...
        public static readonly DependencyProperty FloatButtonBackgroundProperty =
            DependencyProperty.Register("FloatButtonBackground", typeof(Brush), typeof(SwipeListView), new PropertyMetadata(new SolidColorBrush(Color.FromArgb(255, 33, 150, 243))));
        ...
        public static readonly DependencyProperty FloatButtonVisibilityProperty =
            DependencyProperty.Register("FloatButtonVisibility", typeof(Visibility), typeof(SwipeListView), new PropertyMetadata(Visibility.Collapsed));
        ...
        public static readonly DependencyProperty FloatButtonIconProperty =
            DependencyProperty.Register("FloatButtonIcon", typeof(IconElement), typeof(SwipeListView), new PropertyMetadata(null));
        ...
        public static readonly DependencyProperty EmptyDataTemplateProperty = DependencyProperty.Register(
            "EmptyDataTemplate", typeof(DataTemplate), typeof(SwipeListView), new PropertyMetadata(default(DataTemplate)));
        ...
        public static readonly DependencyProperty ScrollOffsetOfLoadMoreTriggerProperty =
            DependencyProperty.Register("ScrollOffsetOfLoadMoreTrigger", typeof(int), typeof(SwipeListView), new PropertyMetadata(300, (s, e) => { if ((s as SwipeListView).ScrollOffsetOfLoadMoreTrigger <= 0) throw new ArgumentException("invalid ScrollOffsetOfLoadMoreTrigger"); }));
        ...
        public static readonly DependencyProperty IsItemSwipeEnabledProperty =
            DependencyProperty.Register("IsItemSwipeEnabled", typeof(bool), typeof(SwipeListView), new PropertyMetadata(true));
        ...
        public static readonly DependencyProperty ItemLeftSwipeContentTemplateProperty =
            DependencyProperty.Register("ItemLeftSwipeContentTemplate", typeof(DataTemplate), typeof(SwipeListView), new PropertyMetadata(null));
        ...
        public static readonly DependencyProperty ItemRightSwipeContentTemplateProperty =
            DependencyProperty.Register("ItemRightSwipeContentTemplate", typeof(DataTemplate), typeof(SwipeListView), new PropertyMetadata(null));
        ...
        public static readonly DependencyProperty ItemBackAnimDurationProperty =
            DependencyProperty.Register("ItemBackAnimDuration", typeof(int), typeof(SwipeListView), new PropertyMetadata(200));
        ...
        public static readonly DependencyProperty ItemLeftSwipeModeProperty =
            DependencyProperty.Register("ItemLeftSwipeMode", typeof(SwipeMode), typeof(SwipeListView), new PropertyMetadata(SwipeMode.None));
        ...
        public static readonly DependencyProperty ItemLeftBackAnimEasingFunctionProperty =
            DependencyProperty.Register("ItemLeftBackAnimEasingFunction", typeof(EasingFunctionBase), typeof(SwipeListView), new PropertyMetadata(new ExponentialEase() { EasingMode = EasingMode.EaseOut }));
        ...
        public static readonly DependencyProperty ItemLeftSwipeLengthRateProperty =
            DependencyProperty.Register("ItemLeftSwipeLengthRate", typeof(double), typeof(SwipeListView), new PropertyMetadata(1.0));
        ...
        public static readonly DependencyProperty ItemLeftSwipeMaxLengthProperty =
            DependencyProperty.Register("ItemLeftSwipeMaxLength", typeof(double), typeof(SwipeListView), new PropertyMetadata(0.0));
        ...
        public static readonly DependencyProperty ItemLeftActionRateForSwipeLengthProperty =
            DependencyProperty.Register("ItemLeftActionRateForSwipeLength", typeof(double), typeof(SwipeListView), new PropertyMetadata(0.5));
        ...
        public static readonly DependencyProperty ItemRightSwipeModeProperty =
            DependencyProperty.Register("ItemRightSwipeMode", typeof(SwipeMode), typeof(SwipeListView), new PropertyMetadata(SwipeMode.None));
        ...
        public static readonly DependencyProperty ItemRightBackAnimEasingFunctionProperty =
            DependencyProperty.Register("ItemBackEasingFunction", typeof(EasingFunctionBase), typeof(SwipeListView), new PropertyMetadata(new ExponentialEase() { EasingMode = EasingMode.EaseOut }));
        ...
        public static readonly DependencyProperty ItemRightSwipeLengthRateProperty =
            DependencyProperty.Register("ItemRightSwipeLengthRate", typeof(double), typeof(SwipeListView), new PropertyMetadata(1.0));
        ...
        public static readonly DependencyProperty ItemRightSwipeMaxLengthProperty =
            DependencyProperty.Register("ItemRightSwipeMaxLength", typeof(double), typeof(SwipeListViewItem), new PropertyMetadata(0.0));
        ...
        public static readonly DependencyProperty ItemRightActionRateForSwipeLengthProperty =
            DependencyProperty.Register("ItemRightActionRateForSwipeLength", typeof(double), typeof(SwipeListView), new PropertyMetadata(0.5));
        ...
        public static readonly DependencyProperty IsSwipedRightMemberPathProperty =
            DependencyProperty.Register("IsSwipedRightMemberPath", typeof(string), typeof(SwipeListView), new PropertyMetadata(null));
        ...
        public static readonly DependencyProperty IsSwipedLeftMemberPathProperty =
            DependencyProperty.Register("IsSwipedLeftMemberPath", typeof(string), typeof(SwipeListView), new PropertyMetadata(null));
        ...
        public static readonly DependencyProperty EnableSwipeRightMemberPathProperty =
            DependencyProperty.Register("EnableSwipeRightMemberPath", typeof(string), typeof(SwipeListView), new PropertyMetadata(null));
        ...
        public static readonly DependencyProperty EnableSwipeLeftMemberPathProperty =
            DependencyProperty.Register("EnableSwipeLeftMemberPath", typeof(string), typeof(SwipeListView), new PropertyMetadata(null));
        ...
        public SwipeListView()
        {
            ...
            Loaded += SwipeListView_Loaded;
            Unloaded += SwipeListView_OnUnloaded;
        }

        protected override DependencyObject GetContainerForItemOverride()
        {
            SwipeListViewItem item = new SwipeListViewItem();
            SetItemBinding(item, SwipeListViewItem.LeftSwipeModeProperty, "ItemLeftSwipeMode");
            SetItemBinding(item, SwipeListViewItem.RightSwipeModeProperty, "ItemRightSwipeMode");
            SetItemBinding(item, SwipeListViewItem.BackAnimDurationProperty, "ItemBackAnimDuration");
            SetItemBinding(item, SwipeListViewItem.LeftBackAnimEasingFunctionProperty, "ItemLeftBackAnimEasingFunction");
            SetItemBinding(item, SwipeListViewItem.RightBackAnimEasingFunctionProperty, "ItemRightBackAnimEasingFunction");
            SetItemBinding(item, SwipeListViewItem.LeftSwipeContentTemplateProperty, "ItemLeftSwipeContentTemplate");
            SetItemBinding(item, SwipeListViewItem.RightSwipeContentTemplateProperty, "ItemRightSwipeContentTemplate");
            SetItemBinding(item, SwipeListViewItem.LeftSwipeLengthRateProperty, "ItemLeftSwipeLengthRate");
            SetItemBinding(item, SwipeListViewItem.LeftActionRateForSwipeLengthProperty, "ItemLeftActionRateForSwipeLength");
            SetItemBinding(item, SwipeListViewItem.RightSwipeLengthRateProperty, "ItemRightSwipeLengthRate");
            SetItemBinding(item, SwipeListViewItem.RightActionRateForSwipeLengthProperty, "ItemRightActionRateForSwipeLength");
            SetItemBinding(item, SwipeListViewItem.LeftSwipeMaxLengthProperty, "ItemLeftSwipeMaxLength");
            SetItemBinding(item, SwipeListViewItem.RightSwipeMaxLengthProperty, "ItemRightSwipeMaxLength");
            SetItemBinding(item, SwipeListViewItem.IsSwipeEnabledProperty, "IsItemSwipeEnabled");
            SetItemBinding(item, SwipeListViewItem.IsSwipedRightMemberPathProperty, "IsSwipedRightMemberPath");
            SetItemBinding(item, SwipeListViewItem.IsSwipedLeftMemberPathProperty, "IsSwipedLeftMemberPath");
            SetItemBinding(item, SwipeListViewItem.EnableSwipeRightMemberPathProperty, "EnableSwipeRightMemberPath");
            SetItemBinding(item, SwipeListViewItem.EnableSwipeLeftMemberPathProperty, "EnableSwipeLeftMemberPath");
        ...
        private void SetItemBinding(SwipeListViewItem item, DependencyProperty originProperty, string targetProperty)
        {
        ...
        private void SwipeListView_Loaded(object sender, RoutedEventArgs e)
        {
            InitTimer();
            InitVisualState();
        ...
        private void SwipeListView_OnUnloaded(object sender, RoutedEventArgs routedEventArgs)
        {
            if (_timer != null)
            {
        ...
        {
            if (!CanPullToRefresh || !AnyViewUtils.IsOnMobile)
                return;
        ...
        private void InitControls()
        {
            ...
            _floatButton = (FloatButton)GetTemplateChild("FloatButton");
            ...
            AnyViewUtils.SetBase64ToImage((BitmapSource)_floatButtonShadow.Source, FloatBtn_Shadow_Base64);
        }
        ...
        private void InitOtherEvents()
        {
            ...
            SizeChanged += SwipeListView_SizeChanged;
        }
        ...
        private string NormalState { get { return CanPullToRefresh && AnyViewUtils.IsOnMobile ? Normal_State : FloatBtn_Normal_State; } }

        private string RefreshState { get { return CanPullToRefresh && AnyViewUtils.IsOnMobile ? Refreshing_State : FloatBtn_Refreshing_State; } }
        ...
        private void SwipeListView_SizeChanged(object sender, SizeChangedEventArgs e)
        {
