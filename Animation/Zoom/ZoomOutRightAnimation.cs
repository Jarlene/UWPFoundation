...
namespace Animation
{
    public class ZoomOutRightAnimation : AnimationBase
    {
        ...
        public override IAnimation PlayOn(UIElement target, Action continueWith)
        {
            ...
            var transformXAnim = AnimationUtils.CreateAnimationWithValues(Duration.TotalMilliseconds, -30, AnimationUtils.GetParentSize(target).Width - AnimationUtils.GetPointInParent(target).X);
