...
namespace Database
{
    public partial class SQLiteAsyncConnection
    {
        ...
        public Task<CreateTablesResult> CreateTablesAsync<T1, T2>(CreateFlags createFlags = CreateFlags.None)
            where T1 : new()
            where T2 : new()
        {
            return CreateTablesAsync(createFlags, typeof(T1), typeof(T2));
        }

        public Task<CreateTablesResult> CreateTablesAsync<T1, T2, T3>(CreateFlags createFlags = CreateFlags.None)
            where T1 : new()
            where T2 : new()
            where T3 : new()
        {
            return CreateTablesAsync(createFlags, typeof(T1), typeof(T2), typeof(T3));
        }

        public Task<CreateTablesResult> CreateTablesAsync<T1, T2, T3, T4>(CreateFlags createFlags = CreateFlags.None)
            where T1 : new()
            where T2 : new()
            where T3 : new()
            where T4 : new()
        {
            return CreateTablesAsync(createFlags, typeof(T1), typeof(T2), typeof(T3), typeof(T4));
        }

        public Task<CreateTablesResult> CreateTablesAsync<T1, T2, T3, T4, T5>(CreateFlags createFlags = CreateFlags.None)
            where T1 : new()
            where T2 : new()
            where T3 : new()
            where T4 : new()
            where T5 : new()
        {
            return CreateTablesAsync(createFlags, typeof(T1), typeof(T2), typeof(T3), typeof(T4), typeof(T5));
        }
